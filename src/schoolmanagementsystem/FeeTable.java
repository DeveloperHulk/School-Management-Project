...
public class FeeTable extends javax.swing.JFrame {
    ...
    public void DataLoaded() {
        try {
            ...
            while (rs.next()) {
                model.addRow(new Object[]{rs.getString("id"), rs.getString("remainingfee"), rs.getString("paidfee"), rs.getString("totalfee")});
            }
        } catch (Exception e) {
        }
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Remaning Fee", "Paid Fee", "Total Fee"
            }
        ));
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_replay_60px.png"))); // NOI18N
